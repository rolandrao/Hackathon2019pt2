...
class Tornado extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new TornadoPage(title: 'Lessons'),
      // home: DetailPage(),
    );
  }
}

class TornadoPage extends StatefulWidget {
  TornadoPage({Key key, this.title}) : super(key: key);
...
class _TornadoState extends State<TornadoPage> {
  List lessons;
  List Cards;
      ...
      children: <Widget>[
        Card(
          ...
          Container(
              ...
              child: makeListTile(Lesson(
                  title: "Go to the lowest floor possible",
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "Get under something sturdy",
                  level: "Category 3",
                  indicatorValue: 0.0,
                  price: 20,
                  colorTitle: Colors.white,
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "Cover you body with a blanket or mattress",
                  colorTitle: Colors.white,
                  colorSub: Colors.white,
                  content:"" ), MaterialPageRoute(
                  builder: (context) => ListPage())
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "Do not stay in amobile home",
                  colorTitle: Colors.white,
                  colorSub: Colors.white,
                  content:"" ), MaterialPageRoute(
                  builder: (context) => ListPage())

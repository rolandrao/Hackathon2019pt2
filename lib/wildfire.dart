...
class Fire extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new FirePage(title: 'Lessons'),
      // home: DetailPage(),
    );
  }
}
...
class FirePage extends StatefulWidget {
  FirePage({Key key, this.title}) : super(key: key);
...
class _FireState extends State<FirePage> {
  List lessons;
  List Cards;
      ...
      children: <Widget>[
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "If you see a fire report it",
                  level: "-Category 3",
                  indicatorValue: 0.0,
                  price: 20,
                  colorTitle: Colors.white,
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "Make your home easier to spot",
                  colorTitle: Colors.white,
                  colorSub: Colors.white,
                  content:"" ), MaterialPageRoute(
                  builder: (context) => ListPage())
        ...
        Card(
          ...
          Container(
              ...
              decoration: BoxDecoration(color: col, borderRadius: BorderRadius.circular(25)),
              child: makeListTile(Lesson(
                  title: "Remove leaves and rubbish from under structure",
                  colorTitle: Colors.white,
                  colorSub: Colors.white,
                  content:"" ), MaterialPageRoute(
                  builder: (context) => ListPage())
